...
% !Mode:: "TeX:UTF-8"
\chapter{财务分析与融资计划}\label{ux7b2cux516dux7ae0-ux8d22ux52a1ux5206ux6790ux4e0eux878dux8d44ux8ba1ux5212}
...
\section{基本会计与测算假设}\label{ux57faux672cux4f1aux8ba1ux4e0eux6d4bux7b97ux5047ux8bbe}
...
\section{收入预测}\label{ux6536ux5165ux9884ux6d4b}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1450}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1450}}@{}}
\caption{PI OS 收入情景测算（单位：万元）}\tabularnewline
\toprule\noalign{}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5.60000in,height=3.69600in]{figures/image21.png}
  \caption{2027---2029 年收入结构演进图}
\end{figure}

\subsection{年度产品服务收入}\label{ux5e74ux5ea6ux4ea7ux54c1ux670dux52a1ux6536ux5165}
...
\subsection{部署适配与生态合作}\label{ux90e8ux7f72ux9002ux914dux4e0eux751fux6001ux5408ux4f5c}
...
\section{成本分析}\label{ux6210ux672cux5206ux6790}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1345}}
  >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1345}}@{}}
\caption{PI OS 年度经营投入情景（单位：万元）}\tabularnewline
\toprule\noalign{}
\rowcolor{WordTableHeader}
\begin{minipage}[b]{\linewidth}\centering
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1719}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1719}}@{}}
\caption{收入与经营成本对照（单位：万元）}\tabularnewline
\toprule\noalign{}
\rowcolor{WordTableHeader}
\begin{minipage}[b]{\linewidth}\centering
\TableHeaderText{项目}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5.60000in,height=3.69600in]{figures/image22.png}
  \caption{三年收入、经营成本与结余趋势图}
\end{figure}

\section{融资计划}\label{ux878dux8d44ux8ba1ux5212}
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1719}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.1719}}@{}}
\caption{PI OS 基础现金需求测算（单位：万元）}\tabularnewline
\toprule\noalign{}
\rowcolor{WordTableHeader}
\begin{minipage}[b]{\linewidth}\centering
\TableHeaderText{项目}
...
\subsection{首轮资金需求}\label{ux9996ux8f6eux8d44ux91d1ux9700ux6c42}
...
\caption{首轮资金需求构成（单位：万元）}\tabularnewline
\toprule\noalign{}
\rowcolor{WordTableHeader}
\begin{minipage}[b]{\linewidth}\centering
\TableHeaderText{项目}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=5.60000in,height=3.69600in]{figures/image23.png}
  \caption{首轮资金需求形成图}
\end{figure}

\subsection{资金使用与分阶段控制}\label{ux8d44ux91d1ux4f7fux7528ux4e0eux5206ux9636ux6bb5ux63a7ux5236}
